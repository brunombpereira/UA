...
if (x != 0):
    ...
    if (y > 0):
        if (
                y ** 2 <= 225.5 ** 2 and y ** 2 >= 170 ** 2 or y ** 2 == 170 ** 2 or y ** 2 == 162 ** 2 or y ** 2 == 107 ** 2 or y ** 2 == 99 ** 2 or y ** 2 == 16 ** 2 or y ** 2 == 6.35 ** 2):
            print('Pontos: 0')
...
if (
        x ** 2 + y ** 2 <= 225.5 ** 2 and x ** 2 + y ** 2 >= 170 ** 2 or x ** 2 + y ** 2 == 170 ** 2 or x ** 2 + y ** 2 == 162 ** 2 or x ** 2 + y ** 2 == 107 ** 2 or x ** 2 + y ** 2 == 99 ** 2 or x ** 2 + y ** 2 == 16 ** 2 or x ** 2 + y ** 2 == 6.35 ** 2):
    print(f'Pontos: 0')
