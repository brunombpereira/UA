#Contador Johnson de 4 bits (sequência: 0000, 0001, 0011, 0111, 1111, 1110, 1100, 
# 1000, 0000, 0001, ...), com uma frequência de atualização de 1.5 Hz
...
delay:          li $v0,11               # readCoreTimer()
                ...
                andi $t4,$s0,0x8        # isolar o bit mais significativo do contador
                srl  $t4,$t4,3          # colocá-lo no bit menos significativo 
                xor $t4,$t4,1           # para negar o bit menos significativo que isolamos no passo anterior
                sll $t5,$s0,1           # o $s0 era _ _ _ _ passa a ser em $t5 _ _ _ 1
